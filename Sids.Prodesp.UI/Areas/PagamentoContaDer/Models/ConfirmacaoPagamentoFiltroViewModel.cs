...
namespace Sids.Prodesp.UI.Areas.PagamentoContaDer.Models
{
    public class ConfirmacaoPagamentoFiltroViewModel
    {
        ...
        public ConfirmacaoPagamentoFiltroViewModel CreateInstance(ConfirmacaoPagamento entity, FormCollection form)
        {
            ...
            filtro.TipoConfirmacao = !string.IsNullOrEmpty(form["TipoConfirmacao"]) ? form["TipoConfirmacao"] : string.Empty;
        ...
        public IList<SelectListItem> CarregarTipoPagamento()
        {
            return new List<SelectListItem>
           {
                    ...
                    new SelectListItem {Text = "11 - ORDEM BANCARIA",Value = "11"},
                    new SelectListItem {Text = "12 - CHEQUE PGTO",Value = "12"},
                    new SelectListItem {Text = "13 - CHEQUE PRACA",Value = "13"},
                    new SelectListItem {Text = "14 - CHEQUE FORA",Value = "14"},
                    new SelectListItem {Text = "15 - DINHEIRO",Value = "15"},
                    new SelectListItem {Text = "16 - LIMITE DE SAQUE",Value = "16"},
                    new SelectListItem {Text = "17 - SUPRIMENTO",Value = "17"},
                    new SelectListItem {Text = "18 - DESPESA-COMPENS",Value = "18"},
                    new SelectListItem {Text = "19 - RECEITA-COMPENS",Value = "19"},
                    new SelectListItem {Text = "21 - BOLETIM",Value = "21"},
                    new SelectListItem {Text = "22 - CAUCAO TITULOS",Value = "22"},
                    new SelectListItem {Text = "23 - CREDORES",Value = "23"}
